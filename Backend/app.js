...
import user from './models/checkout.js';
import comment from './models/comment.js'
const app = express();
app.use(bodyParser.json())
app.use(cors())
mongoose.connect('mongodb+srv://JyothiSri:kXmmCYiLMGa14bpO@cluster0.76v7jxe.mongodb.net/CakenBake?retryWrites=true&w=majority&appName=Cluster0')
    ...
    {
        console.log(req.body.formdata)
        const{name, email, cmnt} = req.body.formdata
