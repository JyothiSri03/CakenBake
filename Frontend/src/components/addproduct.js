...
function Addproduct(){
    ...
    let backend_api="http://localhost:1404/addproduct"
    const handlesubmit=(e)=>{
        const Inputfields=new FormData()
        Inputfields.append('myfile',formdata.img)
    ...
    return(
        <div>
            ...
            <label>title: </label>
                ...
                <br/>
                <label>Upload: </label>
                <input type="file"  name="myfile"   onChange={(e)=>setFormdata({...formdata,img:e.target.files[0]})}/>
                <br/>
